...
router.post('/', isLoggedIn, upload.array('image'), validateSanitizeCampground, catchAsync(async (req, res)=>{
...
router.put('/:id', isLoggedIn, upload.array('image'), isOwner, validateSanitizeCampground, catchAsync(async (req, res, next)=>{
        const {id} = req.params
